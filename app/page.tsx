  ...
  return <main>
    ...
    <section className="hero paper"><div className="container hero-grid">
      <div className="hero-copy">
        ...
        <div className="hero-action"><ArrowButton href="#ofertas">Quiero las +100 recetas</ArrowButton><div className="price"><del>$26.900</del><strong>$9.900</strong><small>solo hoy</small></div></div>
